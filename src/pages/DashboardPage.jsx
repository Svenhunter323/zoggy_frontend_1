...
// console.log("dashboard data:", dashboardData)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
      ...
      {/* Hero Banner */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-2xl md:text-3xl text-gray-200 mb-16 max-w-3xl mx-auto font-montserrat font-light leading-relaxed">
              ...
              <span className="text-gold font-medium">Your journey to $10,000 starts here</span>
            </p>
          </motion.div>
        </div>
      </section>
